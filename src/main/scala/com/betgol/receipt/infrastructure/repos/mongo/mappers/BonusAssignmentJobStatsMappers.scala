...
object BonusAssignmentJobStatsMappers {

  extension (stats: BonusAssignmentJobStats) {
  ...
  extension (d: BsonDocument) {
    def toBonusAssignJobStats: Either[String, BonusAssignmentJobStats] =
      for {
